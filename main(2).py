...
class BanckAcount:
  ...
  def deposit(self, amount):
    if amount > 0:
      ...
      # self.__account_balance = self __account_bslance+amount
      print("Deposited £{}.New balance: £{}".format(amount,self.__account_balance))

    else:
      print("Invalid deposit amount.pleace deposit a positive amoun.")
...
account =  BanckAcount(account_number="123456789", account_holder_name="Hari     prabu",
